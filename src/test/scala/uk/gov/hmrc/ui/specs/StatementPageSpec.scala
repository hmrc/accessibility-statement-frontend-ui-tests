...
import uk.gov.hmrc.ui.pages.{FullyAccessibleStatementPage, NonAccessibleStatementPage, PartiallyAccessibleStatementPage}

import scala.jdk.CollectionConverters.CollectionHasAsScala

class StatementPageSpec extends BaseSpec {
  ...
  Feature("Statement page") {
    Scenario(
      ...
      FullyAccessibleStatementPage.goTo()
  ...
  Scenario(
    ...
    PartiallyAccessibleStatementPage.goTo()
  ...
  Scenario("The user visits a statement page for a non accessible service") {
    ...
    NonAccessibleStatementPage.goTo()
    ...
    driver()
      ...
      .map(_.getText) should
      contain(
        "It has not been tested for compliance with WCAG 2.1 AA. The service will book a full accessibility audit by 30 September 2025."
      )
  }
